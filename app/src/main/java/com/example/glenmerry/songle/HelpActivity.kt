...
class HelpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewHelp.text = Html.fromHtml("<b>What is Songle?</b><br /><br /><small>Songle is a location-based puzzle game where you can walk through your favourite songs! " +
                "Collect words from well-known lyrics in order to guess the song, while exploring your local area! <br /><br />" + "<b></small>How do I play?<br/><br/><small></b>" +
                "Tap the 'Play' button to enter the map view. You will see placemarks which represent the words on the map, once you're within 10 metres of one, collect it, by" +
